      ...
      <div class="col-xs-12 col-md-4 col-md-offset-4">
        ...
        <div>
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" id="username" placeholder="Ingresa el nuevo nombre">
          </div>
          <div id="resp"></div>
          <!-- Div espaciador -->
          <div class="spacing-2"></div>
          <button type="button" class="btn btn-primary btn-block" id="c_username">Cambiar</button>
        </div>
    </div>
  </div>
