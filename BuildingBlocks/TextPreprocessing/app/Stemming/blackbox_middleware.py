...
def execute(params):
    ...
    """ 
    LOGER.error("SIIIUUUU" + str(type(params)))
    LOGER.error("SIIIUUUU 2" + str(ACTUAL_PATH))
    #filepath = params['inputpath']
    params['inputfile'] = params['inputpath']+params['inputfile']+".csv"
    params['outputfile']  = params['inputpath']+params['outputfile']+".csv"
