...
ruta_salida_clasificador=None, ruta_salida_reporte=None, ruta_salida_imagen_confusion=None, ruta_salida_imagen_densidad=None, ruta_salida_imagen_cajas=None,columnas_interes=None,columna_clase = None, num_iteraciones=5, is_indexed=True, average='micro',
...
class_weight=None, verbose=False, max_iter=- 1, decision_function_shape='ovr', break_ties=False, random_state=None
    ...
    clasificador_entrenado, clasificador=clasificar (entrenamiento_datos, entrenamiento_clase, average=average, C=C, kernel=kernel, degree=degree, gamma=gamma, coef0=coef0, shrinking=shrinking, probability=probability, tol=tol, cache_size=cache_size, 
        class_weight=class_weight, verbose=verbose, max_iter=max_iter, decision_function_shape=decision_function_shape, break_ties=break_ties, random_state=random_state)
    #print(texto)
...
def bootstrap (clasificador, datos_entrada, columna_clase, num_iteraciones, average):
    ...
    texto, disp=metricas (prueba_clase_acumulado, prediccion_prueba_acumulado, average=average)
