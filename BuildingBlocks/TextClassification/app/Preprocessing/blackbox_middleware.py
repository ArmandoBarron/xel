...
NAME_APPLICATION = "Preprocessing"
...
def execute(params):
    ...
    execution_status = os.system('python3 '+ACTUAL_PATH+'T.py "'+params['inputfile']+'" "'+ACTUAL_PATH+'" "'+params['labelColumn']+'" "'+params['contentColumn']+'" "'+params['objective']+'"')
    
    # create a ZipFile object
    with ZipFile(outputfile, 'w') as zipObj:
        zipObj.write(ACTUAL_PATH+'xtrain.pkl', 'xtrain.pkl')
        zipObj.write(ACTUAL_PATH+'xtest.pkl', 'xtest.pkl')
        zipObj.write(ACTUAL_PATH+'ytrain.pkl', 'ytrain.pkl')
        zipObj.write(ACTUAL_PATH+'ytest.pkl', 'ytest.pkl')
