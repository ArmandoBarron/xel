...
def execute(params):
    ...
    """ 
    grobid_inputzip = params['inputpath']+params['inputfile']+".zip"  #where the input data is
    ...
    params['input_distance_filename'] = grobid_inputpath +"/" +params['input_distance_filename']
