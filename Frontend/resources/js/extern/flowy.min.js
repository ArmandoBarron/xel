var flowy = function (canvas, grab, release, snapping, rearrange, onblockchange, spacing_x, spacing_y) {
    if (!onblockchange) {
    ...
    flowy.load = function () {
        ...
        ml = 499;
        mt = 23;
        root = `<div id="root" class="blockelem noselect card block"
        ...
        <div class="card-header bg-primary text-white text-center">DATA SOURCES <div id="Inspect_datasource" ></div> </div>
        <div class="card-body py-4 px-4">

        <div class="card-text"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span> <strong id="listOfDatasources">No data source selected.</strong></div></div>
        <div class="card-footer bg-dark text-white">
        <div style="padding:1px;" class="service-options">
                <div id="rawdata_button" >
                        <button style="margin:1px;display:none" onclick="Pre_exe_graph()" class="btn btn-primary btn-sm btn-block"><span class="glyphicon glyphicon-signal" aria-hidden="true"></span> load data</button>
                </div>
                <div id="cleandata_button" style="display:none" >
                        <button  style="margin:1px;" onclick="Clean_graph_data()" class="btn btn-primary btn-sm btn-block"><span class="glyphicon glyphicon-floppy-remove" aria-hidden="true"></span> remove data</button>
                </div>
        </div>
        <div style="padding:1px;" class="service-options">
                <div>
        ...
        <div style="padding:1px;" class="service-options">
                <div>
                        <button onclick="Upload_graph_data()" id="files_button" style="margin:1px;"  class="btn btn-primary btn-sm btn-block"><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span> upload data</button>
                </div>
        </div>
        <div class="service-options">
                        <div class="showOnMapIcon-raw"  id="showOnMapIcon-raw"></div>
                        <div class= "serviceLoadingIcon-raw" id="serviceLoadingIcon-raw"></div>
                        <div class="downloadDataIcon-raw" id="downloadDataIcon-raw"></div>
        </div>
        </div></div>
        <div class='indicator invisible'></div>`;

        //canvas_div.innerHTML= root
        ...
        flowy.import = function (output) {
            ...
            for (var a = 0; a < output.blockarr.length; a++) {
                console.log(`from flowy: blockarr[${a}]=`, output.blockarr[a]);
                var block = {
        ...
        function rearrangeMe() {
            console.log('------------------------------ rearrangeMe() Function -----------------------');
            ...
            for (var z = 0; z < result.length; z++) {
                ...
                for (var w = 0; w < blocks.filter(id => id.parent == result[z]).length; w++) {
                    ...
                    if (children.childwidth > children.width) {
                        ...
                        console.log('from flowy: r_array: ', r_array);
            ...
            console.log('-------------------- END rearrangeMe() Function ------------------------');
            console.log("ready hoverintent")
            $(".block-hoverinfo").hoverIntent( confighover ) //esta linea fue agregada para que funcione el hoverintent, no afecta a flowey
        }
    }
    flowy.load();
