...
if(isset($_POST['coordenadas'])){
	...
	$clustering_params = $_POST['clustering_params'];
	$query = $_POST['query'];
	...
	$data = array("polygon" => $polygon_array,"K"=>$K,"algorithms"=>$algorithms,"columns"=>$columns,"sil"=>$sil,"fuentes"=>$fuentes,"clustering_params"=>$clustering_params,"query"=>$query);
