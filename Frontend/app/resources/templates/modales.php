...
<div class="modal fade" id="modal_config" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
		<div class="modal-dialog" role="document">
          ...
          <div class="container">
              ...
              <div class="form-group row col-12">
                <label class="checkbox-inline">
                  <input type="checkbox" data-toggle="toggle" id="patt-active" data-offstyle="outline-dark" data-onstyle="outline-danger" data-style="ios"> Pattern Status
                </label>
              </div>
              ...
              <div class="form-group row col-12">
                <label>Pattern</label>
                    <select id="patt-kind" required data-actions-box='true' class="form-control selectpicker" data-size="5" data-live-search="true" onchange="OptionsHandler(this)" required>
                      <option></option>        
                ...
                <div class="form-group" opth opt-patt-kind="Map">
                  <div class="form-group col-12">
                    <label>Variables (Levels) </label>
                        <input class="form-control autocomplete-column" type="text" id="patt-variables"></label>
                  </div>

                  <div class="form-group col-12">
                      <label> Limit threads to number of workers
                        <input type="checkbox" data-toggle="toggle" data-on="Yes" data-off="No" id="patt-limit_threads" data-offstyle="outline-dark" data-onstyle="outline-danger"></label> 
                    </div>

                  <div class="form-group col-12">
                      <label>Workers
                          <input class="form-control" type="number" min=1 id="patt-workers"></label>
                    </div>
                  </div>


                <div class="form-group" opth opt-patt-kind="Reduce Chain">
                      <div class="form-group col-12">
                        <label>Reduce mode</label>
                        <select id="patt-reduce_mode" required class="form-control selectpicker" data-size="5" data-live-search="true" required>
                          <option></option>        
                ...
                <div class="form-group" opth opt-patt-kind="Reduce">

                        <div class="form-group col-12">
                          <label>Levels to process: </label>
                          <select id="patt-level_to_process" required multiple data-actions-box='true' class="form-control selectpicker" data-size="5" data-live-search="true" required>
                            <option></option>        
          ...
          <div id="modal_config_footer" class="modal-footer">
            <button onclick="Save_configurations()" type="button" class="btn btn-primary">Save</button>
...
<div class="modal fade " id="modExpirado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-sm ">
    <div class="modal-content ">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" onclick="LogOutUser()" ><?php echo $lngarr['reload'] ?></button>
      </div>
    </div>
  </div>
</div>
...
<div id="loginmodal" class="modal fade" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog modal-login">
        ...
        <div class="avatar">
          ...
          <ul id="logintabs" class="nav nav-tabs nav-fill" role="tablist">
            <li class="nav-item" >
              <a class="nav-link active" data-toggle="tab" href="#login_panel">
              Login <i class="fas fa-boxes"></i>
              </a>
            </li>
            <li class="nav-item" >
              <a class="nav-link" data-toggle="tab" href="#signup_panel">
              Sign up <i class="fas fa-boxes"></i>
              </a>
            </li>
          </ul>
      </div> <!--modal header-->
        ...
        <div class="tab-content">
            ...
            <div id="login_panel" class="tab-pane active container-fluid">
              <h4 class="modal-title">Login</h4>

                <div class="modal-body">
                  <form method="post" id="loginuserform">
                    <div class="form-group">
                      <input type="text" class="form-control" id="username_login" name="username" placeholder="Username" required="required">		
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <button id="btnLogGhest" class="btn btn-outline-primary btn-lg btn-block login-btn"><?php echo $lngarr['invitado'];?></button>
                    </div>
              ...
              <div id="signup_panel" class="tab-pane options container-fluid">
              <h4 class="modal-title">Sign up</h4>
  
                <div class="modal-body">
                  <form onsubmit="RegisterNewUser()" method="post" id="registeruserform" >
                    <div class="form-group">
                      <input type="text" class="form-control" id="username_register" name="username" placeholder="Username" required="required">		
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control"  id="email_register" name="email" placeholder="Email" required="required">		
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control" id="pass1_register" name="password" placeholder="Password" required="required">	
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control" id="pass2_register" name="confirm-password" placeholder="Confim password" required="required">	
                    </div>   
                    <div class="form-group">
			...
			<div class="modal-footer">
            <a data-toggle="tab" href="#signup_panel" style="text-align:center;display:block;" href="#">Forgot Password?</a>
